    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500">Control all features, pricing, and payment methods.</p>
        </div>
          ...
          {[
            ...
            <button key={t.key} onClick={() => setTab(t.key as typeof tab)}
              className={`px-4 py-2 text-sm font-medium rounded-t-lg transition ${
                tab === t.key ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'
              }`}>
              {t.label}
            </button>
          ))}
        ...
        {tab === 'payments' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white">🔷 Crypto — Ethereum (USDT / USDC)</h3>
                  <p className="text-xs text-gray-500">ERC-20 — all countries</p>
                </div>
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">BEP-20 — all countries</p>
                </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 text-xs text-blue-700 dark:text-blue-300">
              <strong>Routing:</strong> Nigeria → Bank Transfer + Crypto. Outside Nigeria → Flutterwave + PayPal + Crypto.
              All non-Flutterwave payments require admin confirmation before activation.
            </div>
